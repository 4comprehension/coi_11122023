...
class L5_ParallelFluxProcessingTest {
    ...
    void l1_processParallel() {
        ...
        StepVerifier.create(L5_ParallelFluxProcessing.L1_processParallel(source, doubleFn, e).log())
    ...
    void l2_processParallelOrdered() {
        ...
        StepVerifier.create(L5_ParallelFluxProcessing.L2_processParallelOrdered(source, doubleFn, e).log())
    ...
    void l3_processInGroups() {
        ...
        StepVerifier.create(L5_ParallelFluxProcessing.L3_processInGroups(source, doubleFn, e).log())
          .expectNextCount(3)
          .expectComplete()
          .verifyThenAssertThat()
          .tookLessThan(Duration.ofMillis(4200));
    ...
    void l4_flatMapReduce() {
        ...
        StepVerifier.create(L5_ParallelFluxProcessing.L4_flatMapReduce(source, doubleFn, e).log())
          .expectNext(20L)
          .expectComplete()
          .verifyThenAssertThat()
          .tookLessThan(Duration.ofMillis(4200));
    ...
    void l5_processOnTwoExecutors() {
        ...
        StepVerifier.create(L5_ParallelFluxProcessing.L5_processOnTwoExecutors(source, doubleFn1, doubleFn2, e1, e2)
            .log())
    ...
    void l6_processStaged() {
        ...
        StepVerifier.create(L5_ParallelFluxProcessing.L6_processStaged(source, doubleFn1, doubleFn2, e1, e2)
            .log())
          .expectNextMatches(l -> l.containsAll(List.of(4, 8, 12, 16)))
          .expectComplete()
          .verifyThenAssertThat()
