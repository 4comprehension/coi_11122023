...
import static com.for_comprehension.reactor.E1_reactive.L6_LifecycleHooks.L1_newSubscriptionHook;
import static com.for_comprehension.reactor.E1_reactive.L6_LifecycleHooks.L2_cancellationHook;
import static com.for_comprehension.reactor.E1_reactive.L6_LifecycleHooks.L3_nextHook;
import static com.for_comprehension.reactor.E1_reactive.L6_LifecycleHooks.L4_errorHook;
import static com.for_comprehension.reactor.E1_reactive.L6_LifecycleHooks.L5_terminationHook;
import static com.for_comprehension.reactor.E1_reactive.L6_LifecycleHooks.L6_finallyHook;
import static com.for_comprehension.reactor.E1_reactive.L6_LifecycleHooks.L7_firstHooksSequence;
...
class L6_LifecycleHooksTest {
    ...
    public void testL7_finallyHook() {
        ...
        Flux<Long> flux = L7_firstHooksSequence(Flux.just(1L, 2L, 3L), values);
