...
class L8_BatchingTest {

    @Test
    void L1_buffer() {
        Flux<Integer> numbers = Flux.range(1, 10);
        Flux<List<Integer>> bufferedFlux = L8_Batching.L1_buffer(numbers, 3);
    ...
    void L2_bufferOrTimeout() {
        ...
        Flux<List<Integer>> bufferedFlux = L8_Batching.L2_bufferOrTimeout(numbers, 3, Duration.ofMillis(50));
        StepVerifier.create(bufferedFlux)
          .expectNext(Arrays.asList(1, 2, 3))
          .expectNext(Arrays.asList(4, 5, 6))
          .expectNext(Arrays.asList(7, 8, 9))
    ...
    void L3_overlappingBuffer() {
        ...
        Flux<List<Integer>> bufferedFlux = L8_Batching.L3_overlappingBuffer(numbers, 5, 3);
        StepVerifier.create(bufferedFlux)
