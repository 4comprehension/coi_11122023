...
class L4_TransformationsTest {
    ...
    void testL12_convertSignalsIntoItems() {
        ...
        StepVerifier.create(L4_Transformations.L12_convertSignalsIntoItems(flux))
    ...
    void testL13_zipWithIndex() {
        ...
        StepVerifier.create(L4_Transformations.L13_zipWithIndex(flux))
    ...
    void testL14_wordCount() {
        ...
        StepVerifier.create(L4_Transformations.L14_wordCount(words))
    ...
    void testL15_computePartials() throws Exception {
        StepVerifier.create(L4_Transformations.L15_extractPartialSums(Flux.range(1, 10)))
          .expectNext(1)
          .expectNext(1 + 2)
          .expectNext(3 + 3)
          .expectNext(6 + 4)
