...
public class BufferTest {
    ...
    public void L1_bufferTest() {
        ...
        Flux<List<Integer>> fluxLists = L8_Batching.L1_buffer(fluxInts, 3);
    ...
    public void L2_bufferOrTimeoutTest() {
        ...
        Flux<List<Integer>> fluxLists = L8_Batching.L2_bufferOrTimeout(fluxInts, 5, Duration.ofMillis(25));
    ...
    public void L3_overlappingBufferTest() {
        Flux<Integer> fluxInts = Flux.just(1, 2, 3, 4, 5, 6, 7, 8, 9);
        Flux<List<Integer>> fluxLists = L8_Batching.L3_overlappingBuffer(fluxInts, 5, 3);
